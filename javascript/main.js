...
let timeTwo = new Date("Nov 17, 2023 10:30:20").getTime();
...
let secInterval = setInterval(() => {
  ...
  if (spacesTwo < 0) {
    ...
    dayDiv[1].innerHTML = 0;
    dayDiv[2].innerHTML = 0;

    hoursDiv[1].innerHTML = 0;
    hoursDiv[2].innerHTML = 0;

    minutesDiv[1].innerHTML = 0;
    minutesDiv[2].innerHTML = 0;

    secondDiv[1].innerHTML = 0;
    secondDiv[2].innerHTML = 0;
  }
}, 1000);
